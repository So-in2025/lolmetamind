...
exports.runStrategicAnalysis = exports.generateStrategicAnalysis = exports.default = void 0;
...
const generateStrategicAnalysis = async (prompt, expectedType = 'object', modelName = 'gemini-2.0-flash') => {
  ...
  const providers = isGemini ? [geminiProvider, openAIProvider] : [openAIProvider, geminiProvider];
  let lastError;
...
const runStrategicAnalysis = exports.runStrategicAnalysis = generateStrategicAnalysis;
