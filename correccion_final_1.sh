...
# ==============================================================================
# SCRIPT DE HOTFIX DE SINTAXIS - CORRECCIÓN DE PROMPT.JS
#
# Objetivo: Corregir el error de sintaxis en el archivo de prompts de la IA
#           causado por un carácter de escape incorrecto.
# ==============================================================================
...
echo -e "${YELLOW}Corrigiendo error de sintaxis en 'src/lib/ai/prompts.js'...${NC}"

# --- Reescribir el archivo con la sintaxis correcta ---
...
echo -e "${GREEN}El archivo 'src/lib/ai/prompts.js' ha sido corregido. ✅${NC}"
echo -e "\nSube este cambio a tu repositorio. Ahora sí, la IA recibirá el prompt correctamente."